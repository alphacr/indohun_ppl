...
class Questionnaire(models.Model):
    ...
    # Stage 1 fields
    nilai_no_1 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_2 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_3 = models.IntegerField(choices=nilai_choices, default=0)
    keterangan_tanggung_jawab_dan_wewenang = models.TextField(
        default='Isi Laporan')
    rekomendasi_tanggung_jawab_dan_wewenang = models.TextField(
        default='Isi Laporan')

    nilai_no_4 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_5 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_9 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_10 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_11 = models.IntegerField(choices=nilai_choices, default=0)
    keterangan_pengembangan_berkelanjutan = models.TextField(
        default='Isi Laporan')
    rekomendasi_pengembangan_berkelanjutan = models.TextField(
        default='Isi Laporan')

    nilai_no_12 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_13 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_18 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_19 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_20 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_21 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_22 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    # Stage 3 fields
    nilai_no_23 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    # Stage 4 fields
    nilai_no_24 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_25 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_26 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_27 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_31 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_32 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_36 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_37 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_38 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_39 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_40 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_41 = models.IntegerField(choices=nilai_choices, default=0)
    keterangan_infrastruktur_dan_operasional = models.TextField(
        default='Isi Laporan')
    rekomendasi_infrastruktur_dan_operasional = models.TextField(
        default='Isi Laporan')

    nilai_no_42 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_43 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_48 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_49 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_50 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_51 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_52 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    nilai_no_53 = models.IntegerField(choices=nilai_choices, default=0)
    ...
    # Stage 5 fields
    nilai_no_54 = models.IntegerField(choices=nilai_choices, default=0)
